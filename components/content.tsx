...
const features = [
  {
    icon: Zap,
    title: "Easier to Build,",
    highlight: "100X Faster",
    description:
      "A whole new world of Development. Let AI handle the heavy lifting, code generation, and optimization, so you can build products, scale users and boost sales affordably.",
  ...
  },
  {
    ...
    description:
      "More businesses choose Codex Developers as their development partner for any platform. From e-commerce to enterprise solutions.",
  ...
  {
    icon: Globe,
    title: "Need Domain Names?",
    description:
      "Look up a domain name that fits your brand or generate business names using our AI tool. Complete web solutions from domain to deployment.",
    action: "Find Domain",
    actionIcon: MessageCircle,
    tagline: "@domainnames.com",
    image: "/images/domain-services.jpg",
    gradient: "from-orange-500 to-pink-600",
  },
  {
    icon: Users,
    title: "Make Sales, Don't Just Build",
    description:
      "Building a website is just the beginning, real success comes from converting visitors into customers with optimized user experiences.",
  ...
  },
  {
    ...
    description:
      "The modern CMS: SEO optimized, blazing fast, and developer friendly. Built with Next.js, WordPress, and headless architectures.",
    action: "Explore CMS",
    actionIcon: MessageCircle,
    tagline: "@codedesign",
    image: "/images/content-management.jpg",
  ...
  },
  {
    ...
    description:
      "Engage customers on your site with our Conversational AI Chatbot that learns your brand's voice, boosts conversions, and builds lasting loyalty.",
    action: "Get Commercial",
    actionIcon: MessageCircle,
    tagline: "Enterprise Solutions Available",
